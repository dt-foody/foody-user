...
const FooterNav = () => {
  ...
  return (
    <div
      ref={containerRef}
      className="FooterNav hidden p-2 bg-white dark:bg-neutral-800 fixed top-auto bottom-0 inset-x-0 z-30 border-t border-neutral-300 dark:border-neutral-700 

...
const DEMO_DATA = [
  {
    id: 1,
    clientName: "Đại Toàn",
    clientAddress: "Việt Nam",
    content:
      "Món ăn đúng như hình ảnh trên Foody. Dịch vụ tuyệt vời, chúng tôi đã có trải nghiệm rất hài lòng!",
  },
  {
    id: 2,
...
const SectionClientSay: FC<SectionClientSayProps> = ({
  ...
  return (
    <div className={`nc-SectionClientSay relative ${className} `}>
      <Heading desc="Hãy cùng xem khách hàng nghĩ gì về Foody" isCenter>
